...
const $e = Q({
  ...
  setup(e, n) {
    ...
    const g = () => {
        var r, p;
        (p = (r = _.value) === null || r === void 0 ? void 0 : r.focus) === null ||
          p === void 0 ||
          p.call(r);
      },
      f = (r) => {
      ...
      () => {
        ...
        return s(
          ...
          [
            ...
            s(
              ve,
              j(j({}, Ee), {}, { onAfterEnter: b, onAfterLeave: b }),
              {
                default: () => [
                  ye(
                    s(
...
const vt = (e) => {
  ...
  return {
    [n]: {
      [`${n}-mask-motion`]: {
        "&-enter, &-appear, &-leave": { "&-active": { transition: `all ${a}` } },
    ...
    const x = () => {
      ...
      ue = M(() => {
        const { zIndex: o, contentWrapperStyle: i } = e,
          v = de.value;
        return [{ zIndex: o, transform: _.value ? O.value : void 0 }, F({}, i), v];
      }),
      pe = (o) => {
      ...
      me = (o) => {
        ...
        return (
          ...
          s(
            "button",
            { key: "closer", onClick: $, "aria-label": "Close", class: `${o}-close` },
...
const Ct = Re(wt),
  ...
  Nt = ["src"],
  Pt = { key: 0, class: "px-3 mb-2 text-[12px] text-[var(--text-gray)] font-black" },
        ...
        _ = [
          {
            list: [
              ...
              { name: "Knowledge", title: "使用教程", icon: "mdi:book-outline" },
            ],
          },
          {
            title: "订阅",
      ...
      return (c, u) => {
        ...
        return (
          ...
          T(
            ...
            [
              d("div", { class: P(c.$style.titleBar) }, [
                d("img", { src: L(a), alt: "logo" }, null, 8, Nt),
                d("p", null, U(L(n)), 1),
              ], 2),
              d("div", { class: P(c.$style.navList) }, [
                (N(),
                T(
                  be,
                  null,
                        ...
                        T(
                          ...
                          we(f.list, (y, b) => (
                            ...
                            T(
                              ...
                              [
                                s(L(R), { icon: y.icon, width: 24 }, null, 8, [
                                  "icon",
                                ]),
              ...
              d("div", { class: P(c.$style.tooltip) }, [
                s(L(R), { width: 32, icon: "fluent:comment-lightning-20-filled" }),
                Lt,
                jt,
                d(
                  "p",
  ...
  Wt = {
    ...
    setup(e) {
      return (n, a) => (
        N(),
        T("div", { class: P(n.$style.sideBar) }, [s(Ie)], 2)
      );
    },
  },
  qt = { $style: Rt },
  ...
  ro = d(
    "a",
    { href: "https://t.me/Tsing_bot", target: "_blank" },
    "@tsing",
    -1
  ),
  so = d(
  ...
  io = Q({
    ...
    setup(e) {
      return (n, a) => (
        N(),
        T("div", { class: P(n.$style.copyright) }, [
          ao,
          d("div", lo, [
          ...
          setInterval(() => {
            ...
            let c = document.querySelector('[aria-label="copyright"]') !== null,
              ...
              f =
                ...
                null
                  ? void 0
                  : k.getAttribute("href")) === "https://t.me/themebuddy",
              y =
                ((D =
                  document.querySelector('[aria-label="copyright"]')
                    .parentElement) == null
                  ? void 0
